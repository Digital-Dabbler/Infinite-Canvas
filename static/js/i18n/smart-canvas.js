(function(){
    ...
    window.StudioI18n.register({
        ...
        "smart.previewSource": { zh: "????", en: "Generated with" },
        "smart.previewPrompt": { zh: "???", en: "Prompt" },
        "smart.previewReproduce": { zh: "????", en: "Recreate" },
        "smart.previewUnknownSource": { zh: "???????", en: "Generation source not recorded" },
        "smart.previewEmptyPrompt": { zh: "???????????", en: "No prompt was recorded for this image" },
        "smart.previewCannotReproduce": { zh: "??????????????", en: "Generation settings are missing, so this workflow cannot be recreated" },
        "smart.previewReproduced": { zh: "????????????", en: "Workflow recreated in an empty area of the canvas" },
